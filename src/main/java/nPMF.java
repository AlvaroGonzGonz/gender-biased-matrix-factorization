 ...
 */
public class nPMF extends Recommender {
     ...
     */
    public nPMF(DataModel datamodel, Map<String, Object> params) {
        this(
                datamodel,
     ...
     */
    public nPMF(DataModel datamodel, int numFactors, int numIters) {
     ...
     */
    public nPMF(DataModel datamodel, int numFactors, int numIters, long seed) {
     ...
     */
    public nPMF(DataModel datamodel, int numFactors, int numIters, double lambda) {
     ...
     * @param seed Seed for random numbers generation
     */
    public nPMF(DataModel datamodel, int numFactors, int numIters, double lambda, long seed) {
