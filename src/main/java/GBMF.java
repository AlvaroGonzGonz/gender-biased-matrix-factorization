...
public class GBMF extends Recommender {
     ...
     */
    public GBMF(DataModel datamodel, Map<String, Object> params) {
        this(
                datamodel,
     ...
     */
    public GBMF(DataModel datamodel, int numFactors, int numIters) {
