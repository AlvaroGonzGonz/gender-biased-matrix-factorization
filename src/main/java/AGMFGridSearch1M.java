...
public class AGMFGridSearch1M {
    ...
    public static void main (String[] args){
        try{
            ...
            params.addParam("numFactors", new int[] {4, 5, 6, 7, 8, 9});
            params.addParam("numIters", new int[] {100});
            params.addParam("numGroups", new int[] {2, 4, 5, 7});
            params.addParam("lambda_p", new double[] {0.005, 0.01, 0.015});
            params.addParam("lambda_q", new double[] {0.005, 0.01, 0.015});
            params.addParam("lambda_w", new double[] {0.005, 0.01, 0.015});
            params.addParam("gamma_p", new double[] {0.08, 0.09, 0.1});
            params.addParam("gamma_q", new double[] {0.08, 0.09, 0.1});
            params.addParam("gamma_w", new double[] {0.08, 0.09, 0.1});
